...
async function dispatchToMitigator(incident, runbookId, correlationId) {
...
async function sendAlert(incident, reason) {
...
async function handleAuditLog(_req, res) {
    jsonResponse(res, 200, { entries: getAuditLog() });
}
async function handleHealth(_req, res) {
    jsonResponse(res, 200, { ok: true, agent: "operator" });
}
async function handleApproval(req, res, approvalId, approve) {
...
const TRUST_LABELS = ["observe", "suggest", "approve", "auto-remediate"];
