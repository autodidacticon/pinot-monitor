...
export const runbooks: Runbook[] = [
  ...
  },
  {
    ...
    actions: [
      {
        tool: 'kubectl_delete',
        args: { resource: 'pod', name: '${pod}', namespace: 'pinot', selector: 'component=broker' },
      },
    ],
  ...
  },
  {
    ...
    actions: [
      {
        tool: 'kubectl_get',
        args: { subcommand: 'describe', resource: 'pod', name: '${pod}', namespace: 'pinot' },
      },
    ],
  ...
  },
  {
    ...
    actions: [{ tool: 'pinot_rebalance', args: { table: '${table}' } }],
